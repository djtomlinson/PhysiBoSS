...
list-projects:
	...
	@echo "                 celltypes3-sample heterogeneity-sample heterogeneity-3D pred-prey-farmer virus-macrophage-sample worm-sample spatial"
	@echo ""
	@echo "Sample intracellular projects: template_BM ode-energy-sample physiboss-cell-lines-sample physiboss-tnf-model cancer-metabolism-sample cancer_box"
	@echo ""
...
spatial:
	cp ./sample_projects/set_up_spatial/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects/set_up_spatial/main-spatial.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects/set_up_spatial/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml 
	cp ./sample_projects/set_up_spatial/config/* ./config/
...
cancer_box:
	cp ./sample_projects_intracellular/boolean/cancer_box/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./sample_projects_intracellular/boolean/cancer_box/main-cancer_box.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./sample_projects_intracellular/boolean/cancer_box/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml 
	cp ./sample_projects_intracellular/boolean/cancer_box/config/* ./config/
	cp -r ./sample_projects_intracellular/boolean/cancer_box/scripts ./
